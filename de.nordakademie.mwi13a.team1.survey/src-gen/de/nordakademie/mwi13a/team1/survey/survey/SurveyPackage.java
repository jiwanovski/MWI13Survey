...
public interface SurveyPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Matrix Scale</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int MATRIX__MATRIX_SCALE = SURVEY_TERMINAL_TYPES_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.nordakademie.mwi13a.team1.survey.survey.Matrix#getMatrixScale <em>Matrix Scale</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Matrix Scale</em>'.
   * @see de.nordakademie.mwi13a.team1.survey.survey.Matrix#getMatrixScale()
   * @see #getMatrix()
   * @generated
   */
  EReference getMatrix_MatrixScale();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Matrix Scale</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference MATRIX__MATRIX_SCALE = eINSTANCE.getMatrix_MatrixScale();
